...
const TypeAnimation = dynamic(
  ...
  { ssr: false, loading: () => <span className="text-green-500">Loading...</span> }
);
        ...
        <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-10">
          ...
          >
            <div className="relative profile-container">
              {/* Background animated effects (Now always visible) */}
              <div className="absolute -top-6 -left-6 w-24 h-24 rounded-full bg-green-500/20 filter blur-xl animate-pulse-slow"></div>
              <div className="absolute -bottom-6 -right-6 w-24 h-24 rounded-full bg-blue-500/20 filter blur-xl animate-pulse-slow animation-delay-1000"></div>

              <div className="absolute -inset-0.5 bg-gradient-to-r from-green-500 to-blue-500 rounded-[30%_70%_70%_30%/30%_30%_70%_70%] opacity-75 blur-sm animate-morph-slow"></div>
              <div className="absolute -inset-1 bg-gradient-to-r from-green-500 to-blue-500 rounded-[30%_70%_70%_30%/30%_30%_70%_70%] opacity-50 blur-md animate-morph-slow animation-delay-1000"></div>
